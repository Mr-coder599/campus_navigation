...
class NavigationScreen extends StatefulWidget {
  ...
  final double lng;
  final User user;
  NavigationScreen(this.lat, this.lng, this.user);
...
class _NavigationScreenState extends State<NavigationScreen> {
                        ...
                        child: IconButton(
                          ...
                          onPressed: () async {
                            await launchUrl(Uri.parse(
                                'google.navigation:q=${widget.lat}, ${widget.lng}&key=AIzaSyD3evXQlxOuqqxstfksOOzM57ybAH6z07Y'));
                          },
                        ),
                      ),
                    ))
  ...
  getDirections(LatLng dst) async {
    ...
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
        'AIzaSyD3evXQlxOuqqxstfksOOzM57ybAH6z07Y',
