...
import 'package:campus_app/shape_image_positioned.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: CupertinoPageScaffold(
        ...
        child: Stack(
          children: [
            ShapeImagePositioned(),
            // const Shape(),
            ShapeImagePositioned(),
            ShapeImagePositioned(top: -100),
            ShapeImagePositioned(top: -150),
            ShapeImagePositioned(top: -200),
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Center(
                  //   child: Text(
                  //     'Developed by Hibertech Solution @2023',
                  //     style: TextStyle(
                  //       fontWeight: FontWeight.bold,
                  //       color: Colors.white,
                  //     ),
